...
# We'll install the CUDA wheel first (adjust the index URL tag if necessary),
# then install the rest of the requirements. We also enable a pip cache mount
# during build (BuildKit) for faster subsequent builds.
